            ...
            <TabPanel header={t("document.tabPan")}>
                <div className="formgrid grid">
                    ...
                    <div className="field col-6">
                        ...
                        <Dropdown  id="documentCategorieModelDropdown"  value={item ? item.documentCategorieModel : ''} options={documentCategorieModels} onChange={(e) => onDropdownChange(e, 'documentCategorieModel')}   placeholder="Sélectionnez un documentCategorieModel" filter filterPlaceholder="Rechercher un documentCategorieModel" optionLabel="libelle" />
                    </div>
                    <div className="field col-6">
